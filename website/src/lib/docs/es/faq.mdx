...
### ¿Por qué está vacío el perfil de elevación de mi archivo GPX?

Si el perfil de elevación de su archivo GPX está vacío, significa que el archivo GPX no contiene datos de elevación.
Puede añadir datos de elevación a su archivo GPX usando <a href="https://www.gpsvisualizer.com/elevation" target="_blank">GPS Visualizer</a>.
