...
Cuando el punto final de la ruta está lo suficientemente cerca del inicio, puede cambiar el inicio del bucle haciendo clic en cualquier punto de ancla y seleccionando <button><CirclePlay size="16" class="inline-block" style="margin-bottom: 2px" /> Iniciar bucle aquí</button> desde el menú contextual.
