...
Öppnar informationsdialogen för det nu valda filobjektet, där du kan se och ändra dess namn och beskrivning.

### <PaintBucket size="16" class="inline-block" style="margin-bottom: 2px" /> Appearance...

Öppma Utssende-dialogen där du kan ändra färg, opacitet och bredden på de valda filobjekten på kartan.
