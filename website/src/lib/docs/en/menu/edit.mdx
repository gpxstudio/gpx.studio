...
<script lang="ts">
    import { Undo2, Redo2, Info, PaintBucket, EyeOff, FileStack, SquareDashed, ClipboardCopy, Scissors, ClipboardPaste, Trash2, Maximize, Plus } from '@lucide/svelte';
...
### <SquareDashed size="16" class="inline-block" style="margin-bottom: 2px" /> Deselect all
